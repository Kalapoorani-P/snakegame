...
import cvzone 
# from cvzone.HandTrackingModule import ha
pygame.init()
Red = (255,0,0)
Green = (0,255,0)
Blue = (0,0,255)
                ...
                for landmarks in output.multi_hand_landmarks:
                    for id , pos in enumerate(landmarks.landmark):
                        ...
                        if id == 8:
                            ...
                            #move right
                            if pos_x > 300 and pos_y<600 and pos_y>0:
                                print("right",pos_x,pos_y)
                                Speed_x = -3
                                Speed_y = 0
                            #move left
                            if pos_x < 300 and pos_y>0 and pos_y<600:
                                print("left",pos_x,pos_y)
                                Speed_x = 3
                                Speed_y = 0
                            #move up
                            if pos_y < 350 and pos_x<600 and pos_x>0:
